...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        soft: "0 35px 120px -45px hsl(var(--background) / 0.9)",
        glow: "0 0 45px hsl(var(--primary) / 0.6)",
        "glow-soft": "0 0 35px hsl(var(--accent) / 0.35)",
      },
      backgroundImage: {
        "hero-grid":
          "radial-gradient(circle at 1px 1px, hsl(var(--muted-foreground) / 0.09) 1px, transparent 0)",
        "hero-radial":
          "radial-gradient(circle at top, hsl(var(--accent) / 0.25), transparent 60%), radial-gradient(circle at bottom, hsl(var(--primary) / 0.3), transparent 65%)",
      },
    },
  },
  plugins: [animate],
